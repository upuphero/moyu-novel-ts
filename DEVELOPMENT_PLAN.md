...
> 当前进度：Phase 7 已完成（2026-08-13），Phase 8 尚未开始
...
| --- | --- | --- | --- |
| 0 | 身份、既有缺陷与工程基线 | 无 | 完成 |
| 1 | 统一 Parser 与 TXT 适配 | Phase 0 | 完成 |
| 2 | Book ID、状态与语义进度 | Phase 1 | 完成 |
| 3 | TXT 章节索引缓存 | Phase 1；与 Phase 2 共用 bookId | 完成 |
| 4 | EPUB 小说模式 | Phase 1、2 | 完成 |
| 5 | 全书搜索 | Phase 3、4 | 完成 |
| 6 | 阅读进度条 | Phase 2 | 完成 |
| 7 | 中文章节识别升级 | Phase 1、3 | 完成 |
